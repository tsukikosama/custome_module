...
@Tag(name = "商品分类管理 API")
@RestController
@CrudRequestMapping(value = "/biz/productType", api = {Api.PAGE, Api.GET, Api.CREATE, Api.UPDATE, Api.BATCH_DELETE,
    Api.EXPORT, Api.DICT})
public class ProductTypeController extends BaseController<ProductTypeService, ProductTypeResp, ProductTypeDetailResp, ProductTypeQuery, ProductTypeReq> {}