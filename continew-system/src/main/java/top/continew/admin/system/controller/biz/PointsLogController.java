...
@Tag(name = "积分日志管理 API")
@RestController
@CrudRequestMapping(value = "/biz/pointsLog", api = {Api.PAGE, Api.GET, Api.CREATE, Api.UPDATE, Api.BATCH_DELETE,
    Api.EXPORT, Api.DICT})
public class PointsLogController extends BaseController<PointsLogService, PointsLogResp, PointsLogDetailResp, PointsLogQuery, PointsLogReq> {}