...
public class DeptServiceImpl extends BaseServiceImpl<DeptMapper, DeptDO, DeptResp, DeptResp, DeptQuery, DeptReq> implements DeptService, DeptApi {
    ...
    public boolean checkDeptIsExist(Long deptId) {
        DeptResp isExist = this.get(deptId);
        return isExist != null;
    }
    ...
    /**
     * 实现 DeptApi 接口，将 DeptDO 转换为 hr-common 的 DeptResp
     * <p>
     * 用于 crane4j 的 @AssembleMethod 注解
     *
     * @param id 部门 ID
