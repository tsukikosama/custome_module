...
@Tag(name = "轮播图管理 API")
@RestController
@CrudRequestMapping(value = "/biz/carouselImage", api = {Api.PAGE, Api.GET, Api.CREATE, Api.UPDATE, Api.BATCH_DELETE,
    Api.EXPORT, Api.DICT})
public class CarouselImageController extends BaseController<CarouselImageService, CarouselImageResp, CarouselImageDetailResp, CarouselImageQuery, CarouselImageReq> {}