 ...
 */
public interface WishService extends BaseService<WishResp, WishDetailResp, WishQuery, WishReq>, IService<WishDO> {

    /**
     * 心愿转商品
     *
     * @param request 心愿转商品请求参数
     */
    void wishToProduct(WishToProductReq request);
}