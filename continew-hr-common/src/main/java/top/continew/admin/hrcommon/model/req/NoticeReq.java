...
package top.continew.admin.hrcommon.model.req;
...
public class NoticeReq implements Serializable {
    ...
    @SpelNotEmpty(condition = "#this.noticeScope == T(top.continew.admin.hrcommon.model.enums.NoticeScopeEnum).USER", message = "通知用户不能为空")
