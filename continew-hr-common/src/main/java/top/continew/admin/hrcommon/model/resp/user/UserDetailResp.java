...
package top.continew.admin.hrcommon.model.resp.user;
...
public class UserDetailResp extends BaseDetailResp {
    ...
    @AssembleMethod(props = @Mapping(src = "name", ref = "deptName"), targetType = top.continew.admin.hrcommon.api.DeptApi.class, method = @ContainerMethod(bindMethod = "getDeptInfo", resultType = top.continew.admin.hrcommon.model.resp.DeptResp.class))
