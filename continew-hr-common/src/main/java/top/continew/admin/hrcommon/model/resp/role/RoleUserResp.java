...
package top.continew.admin.hrcommon.model.resp.role;
...
public class RoleUserResp implements Serializable {
    ...
    @AssembleMethod(props = @Mapping(src = "name", ref = "deptName"), targetType = DeptApi.class, method = @ContainerMethod(bindMethod = "getDeptInfo", resultType = top.continew.admin.hrcommon.model.resp.DeptResp.class))
    private Long deptId;
