 ...
 */
@Mapper
public interface OvertimeWorkMapper extends BaseMapper<OvertimeWorkDO> {
    IPage<OvertimeWorkResp> customPage(Page page, @Param(Constants.WRAPPER) QueryWrapper<OvertimeWorkDO> wrapper);
}
